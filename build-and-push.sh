...
if [[ "$BUILD_MODE" == "parallel" ]]; then
  ...
  start_builds auth-service audit-service system-service genai-service clinic-service appointment-service user-profile-service admin-server notification-service
  wait_for_builds auth-service audit-service system-service genai-service clinic-service appointment-service user-profile-service admin-server notification-service || exit 1
else
