...
/**
 * Standard API Response wrapper for System Admin Service
 * 
...
public class ApiResponse<T> {
    ...
    // Static factory method for success with message only
    ...
    // Static factory method for error with message and error code
